...
const executeFunction = async ({ 
  ...
  try {
    ...
    if (method !== undefined) requestBody.method = method;
    if (description !== undefined) requestBody.description = description;
    if (headers !== undefined) requestBody.headers = headers;
    if (queryParams !== undefined) requestBody.queryParams = queryParams;
    if (pathVariables !== undefined) requestBody.pathVariables = pathVariables;
    if (pathVariableData !== undefined) requestBody.pathVariableData = pathVariableData;
    if (dataMode !== undefined) requestBody.dataMode = dataMode;
    if (dataOptions !== undefined) requestBody.dataOptions = dataOptions;
    if (rawModeData !== undefined) requestBody.rawModeData = rawModeData;
    if (protocolProfileBehavior !== undefined) requestBody.protocolProfileBehavior = protocolProfileBehavior;
