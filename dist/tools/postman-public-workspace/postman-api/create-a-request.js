 ...
 */
const executeFunction = async ({ collectionId, name, url, method = 'GET', description, headers = 'Content-Type: application/json', queryParams, pathVariables, pathVariableData, dataMode = 'raw', dataOptions = { raw: { language: 'json' } }, rawModeData, protocolProfileBehavior, apiKey }) => {
...
export { apiTool };
//# sourceMappingURL=create-a-request.js.map