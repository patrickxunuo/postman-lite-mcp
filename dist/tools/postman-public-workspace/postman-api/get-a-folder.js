 ...
 */
const executeFunction = async ({ collectionId, folderId, ids = false, uid = false, populate = false, apiKey }) => {
    ...
    try {
        ...
        if (ids)
            params.append('ids', 'true');
        if (uid)
            params.append('uid', 'true');
        if (populate)
...
export { apiTool };
//# sourceMappingURL=get-a-folder.js.map